...
cat <<EOF >/etc/systemd/system/ws-80.service
[Unit]
...
systemctl enable ws-80
systemctl restart ws-80
...
echo "5 Gerenciar portas WebSocket"
echo "6 Instalar SOCKS"
echo "7 Gerenciar portas SOCKS"
echo "8 Instalar BadVPN"
echo "9 Gerenciar portas BadVPN"
echo "10 Firewall"
